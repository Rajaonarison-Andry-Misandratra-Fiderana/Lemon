...
#include "lifecycle/listeners.h"

#include "lifecycle/monitor.h"

#include "lifecycle/xdg.h"

#include "input/devices.h"

#include "lifecycle/destroy.h"
